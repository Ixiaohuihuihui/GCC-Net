...
class DenseRepPointsV2Head(AnchorFreeHead):
    ...
    def forward(self, feats, test=False):
        ...
        cont_score_out_list, cont_offset_out_list = multi_apply(self.forward_pts_head_single, feats)
        if test:
        ...
        return cls_out_list, pts_out_init_list, pts_out_refine_list, pts_score_out, \
               cont_score_out_list, cont_offset_out_list
    ...
    def forward_pts_head_single(self, x):
        ...
        return cls_out, pts_out_init, pts_out_refine, cont_score_out, cont_offset_out
