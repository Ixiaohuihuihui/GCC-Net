...
class MultiRetinex(nn.Module):
    def __init__(self, in_channels, model='MSR', sigma=[30, 150, 300], restore_factor=2.0, color_gain=10.0, gain=270.0, offset=128.0):
