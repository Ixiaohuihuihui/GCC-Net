...
class TwoStageDetectorTwoBranchDetector(BaseDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(TwoStageDetectorTwoBranchDetector, self).__init__(init_cfg)
        if pretrained:
    ...
    def forward_train(self,
        ...
        """
        super(TwoStageDetectorTwoBranchDetector, self).forward_train(img, img_metas)
    ...
    def simple_test(self, img, img_metas, img_retinex, proposals=None, rescale=False):
    ...
    def aug_test(self, imgs, img_metas, img_retinex, rescale=False):
        ...
        of imgs[0].
        """
        x = self.extract_feats(imgs, img_retinex)
        proposal_list = self.rpn_head.aug_test_rpn(x, img_metas)
        return self.roi_head.aug_test(
            x, proposal_list, img_metas, rescale=rescale)

    def onnx_export(self, img, img_metas, img_retinex):
