    ...
    def set_input_data(self, img, bboxes=None, labels=None):
        ...
        if self.return_loss:
            ...
            cfg.data.test.pipeline[1].transforms[-1] = dict(
                type='Collect', keys=['img', 'img_retinex', 'gt_bboxes', 'gt_labels'])
            ...
            if 'img_retinex' in data.keys():
                data['img_retinex'] = [img_retinex.data[0] for img_retinex in data['img_retinex']]
            data['gt_bboxes'] = [
            ...
            data['img'] = data['img'][0]
            if 'img_retinex' in data.keys():
                data['img_retinex'] = data['img_retinex'][0]
