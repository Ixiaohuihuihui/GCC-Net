...
# @Author  : Linhui Dai
# @FileName: deformable_detr_r50_16x2_50e_sku.py
# @Software: PyCharm
# -*- coding: utf-8 -*-
...
data = dict(
    ...
    test=dict(
        ...
        ann_file='/data2/dailh/SKU110K-R-Json/sku110k-r_test.json',
        img_prefix=data_root + 'images/',
        img_scale=(1024, 1024),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
...
work_dir = 'work_dirs/deformable_detr_r50_16x2_50e_sku/'
evaluation = dict(work_dir= work_dir, gt_dir='/data2/dailh/dota/trainval/labelTxt/',
                  imagesetfile='work_dirs/deformable_detr_r50_16x2_50e_dota/test.txt')
