...
model = dict(
    ...
    bbox_head=dict(
        ...
        # loss_iou=dict(type='GDLoss', loss_type='gwd', tau=1.0,
        #                        loss_weight=2.0),
...
data_root = '/data2/dailh/dota15-1024-ms/'
data = dict(
    samples_per_gpu=1,
    workers_per_gpu=2,
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'trainval1024_ms/DOTA1_5_trainval1024_ms.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'trainval1024/DOTA1_5_val1024.json',
    ...
    test=dict(
        ...
        # ann_file=data_root + 'trainval1024/DOTA1_5_val1024.json',
        # img_prefix=data_root + 'trainval1024/images/',
        ann_file=data_root + 'test1024_ms/DOTA1_5_test1024_ms.json',
...
evaluation = dict(work_dir='work_dirs/deformable-detr-ms-dota15/', gt_dir='/data2/dailh/dota15-1024-ms/trainval1024/labelTxt_val/',
                  imagesetfile='/data2/dailh/dota15-1024-ms/trainval1024/test.txt')
optimizer_config = dict(grad_clip=dict(max_norm=35, norm_type=2))
# learning policy
lr_config = dict(policy='step', step=[12])
