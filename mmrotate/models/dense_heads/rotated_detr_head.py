...
class RotatedDETRHead(BaseDenseHead):
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is RotatedDETRHead:
            convert_dict = {
    ...
    def loss(self,
        ...
        # all_gt_rbboxes_list = [gt_ for _ in range(num_dec_layers)]
    ...
    def loss_single(self,
        ...
        return loss_cls, loss_bbox, loss_piou
    ...
    def _get_bboxes_single(self,
        ...
        # det_bboxes = RotBox2Polys_torch(bbox_pred)
