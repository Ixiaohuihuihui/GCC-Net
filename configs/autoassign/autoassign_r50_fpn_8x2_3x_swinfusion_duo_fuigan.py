...
model = dict(
    type='AutoAssign_fusion',
    backbone=dict(
        type='SwinFusionTransformer',
        embed_dims=96,
        depths=[2, 2, 6, 2],
        num_heads=[3, 6, 12, 24],
        window_size=7,
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1344, 768), keep_ratio=False),
...
work_dir = 'work_dirs/autoassign_r50_fpn_8x2_3x_swinfusion_duo_fuigan/'
